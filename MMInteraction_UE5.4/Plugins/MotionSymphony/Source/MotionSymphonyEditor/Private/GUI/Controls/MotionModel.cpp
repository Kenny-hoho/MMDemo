...
FMotionModel::FMotionModel(TObjectPtr<UMotionAnimObject> InMotionAnim, UDebugSkelMeshComponent* InDebugSkelMesh, TArray<UDebugSkelMeshComponent*> InDebugSkelMeshs)
