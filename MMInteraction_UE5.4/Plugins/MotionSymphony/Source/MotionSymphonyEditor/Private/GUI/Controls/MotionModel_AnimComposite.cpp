...
FMotionModel_AnimComposite::FMotionModel_AnimComposite(TObjectPtr<UMotionCompositeObject> InMotionComposite, UDebugSkelMeshComponent* InDebugSkelMesh, TArray<UDebugSkelMeshComponent*> InDebugSkelMeshs)
	:FMotionModel(InMotionComposite, InDebugSkelMesh, InDebugSkelMeshs), AnimComposite(InMotionComposite->AnimComposite)
{
	SnapTypes.Add(FMotionModel::FSnapType::Frames.Type, FMotionModel::FSnapType::Frames);
	SnapTypes.Add(FMotionModel::FSnapType::Notifies.Type, FMotionModel::FSnapType::Notifies);
