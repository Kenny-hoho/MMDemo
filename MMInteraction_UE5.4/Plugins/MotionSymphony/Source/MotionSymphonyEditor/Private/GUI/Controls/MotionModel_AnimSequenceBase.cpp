...
FMotionModel_AnimSequenceBase::FMotionModel_AnimSequenceBase(TObjectPtr<UMotionSequenceObject> InMotionAnim, UDebugSkelMeshComponent* InDebugSkelMesh, TArray<UDebugSkelMeshComponent*> InInteractionDebugSkelMeshs)
	: FMotionModel(InMotionAnim, InDebugSkelMesh, InInteractionDebugSkelMeshs)
	, AnimSequenceBase(InMotionAnim->Sequence)
{
	SnapTypes.Add(FMotionModel::FSnapType::Frames.Type, FMotionModel::FSnapType::Frames);
	SnapTypes.Add(FMotionModel::FSnapType::Notifies.Type, FMotionModel::FSnapType::Notifies);
