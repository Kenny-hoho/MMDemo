...
FMotionModel_BlendSpace::FMotionModel_BlendSpace(TObjectPtr<UMotionBlendSpaceObject> InMotionBlendSpace, UDebugSkelMeshComponent* InDebugSkelMesh, TArray<UDebugSkelMeshComponent*> InInteractionDebugSkelMeshs)
	: FMotionModel(InMotionBlendSpace, InDebugSkelMesh, InInteractionDebugSkelMeshs),
	BlendSpace(InMotionBlendSpace->BlendSpace)
{
	SnapTypes.Add(FMotionModel::FSnapType::Frames.Type, FMotionModel::FSnapType::Frames);
	SnapTypes.Add(FMotionModel::FSnapType::Notifies.Type, FMotionModel::FSnapType::Notifies);
