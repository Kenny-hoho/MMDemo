...
public:
	...
	TArray<UDebugSkelMeshComponent*> InteractionDebugMeshs;
...
public:
	...
	FMotionModel(TObjectPtr<UMotionAnimObject> InMotionAnim, UDebugSkelMeshComponent* InDebugSkelMesh, TArray<UDebugSkelMeshComponent*> InDebugSkelMeshs);
