...
public:
	...
	FMotionModel_BlendSpace(TObjectPtr<UMotionBlendSpaceObject> InMotionBlendSpace, UDebugSkelMeshComponent* InDebugSkelMesh, TArray<UDebugSkelMeshComponent*> InInteractionDebugSkelMeshs);
