...
public:
	...
	FMotionModel_AnimComposite(TObjectPtr<UMotionCompositeObject> InMotionComposite, UDebugSkelMeshComponent* InDebugSkelMesh, TArray<UDebugSkelMeshComponent*> InDebugSkelMeshs);
