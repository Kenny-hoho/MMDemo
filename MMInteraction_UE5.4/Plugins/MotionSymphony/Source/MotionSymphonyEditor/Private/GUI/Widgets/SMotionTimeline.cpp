		...
		[
			...
			[
				...
				[
					...
					.HAlign(HAlign_Center)
					[
						SNew(SMotionTimelineTransportControls, DebugSkelMeshComponent, MotionAnim->AnimAsset, MotionAnim->MotionAnimAssetType, InteractionDebugSkelMeshCoponents)
					]
...
void SMotionTimeline::SetInteractionAnimation(TObjectPtr<UMotionAnimObject> InMotionAnim, UDebugSkelMeshComponent* InDebugMeshComponent, TArray<UDebugSkelMeshComponent*> InInteractionDebugSkelMeshComponents)
{
	MotionAnim = InMotionAnim;
	DebugSkelMeshComponent = InDebugMeshComponent;
	InteractionDebugSkelMeshCoponents = InInteractionDebugSkelMeshComponents;
	...
	if (MotionAnim && DebugSkelMeshComponent)
	{
		...
		case EMotionAnimAssetType::Sequence:
		{
			Model = TSharedPtr<FMotionModel>(new FMotionModel_AnimSequenceBase((UMotionSequenceObject*)MotionAnim, InDebugMeshComponent, InInteractionDebugSkelMeshComponents));
		} break;
		case EMotionAnimAssetType::BlendSpace:
		{
			Model = TSharedPtr<FMotionModel>(new FMotionModel_BlendSpace((UMotionBlendSpaceObject*)MotionAnim, InDebugMeshComponent, InInteractionDebugSkelMeshComponents));
		} break;
		case EMotionAnimAssetType::Composite:
		{
			Model = TSharedPtr<FMotionModel>(new FMotionModel_AnimComposite((UMotionCompositeObject*)MotionAnim, InDebugMeshComponent, InInteractionDebugSkelMeshComponents));
		} break;
		}
