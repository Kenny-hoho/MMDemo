...
private:
	...
	TArray<UDebugSkelMeshComponent*> InteractionDebugSkelMeshCoponents;
...
public:
	...
	void SetInteractionAnimation(TObjectPtr<UMotionAnimObject> InMotionAnim, UDebugSkelMeshComponent* InDebugMeshComponent, TArray<UDebugSkelMeshComponent*> InInteractionDebugSkelMeshComponents);
private:
