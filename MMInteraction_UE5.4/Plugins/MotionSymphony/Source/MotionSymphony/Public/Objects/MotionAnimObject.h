...
public:
	...
	TArray<TObjectPtr<UAnimSequence>> InteractionAnims;
...
public:
	...
	UMotionAnimObject();
	UMotionAnimObject(UAnimationAsset* InAnimAsset, class UMotionDataAsset* InParentMotionData);
	...
	virtual void GetInteractionAnimsRootBoneTransforms(FTransform& OutTransform, int32 interactionIndex, const double Time) const;
...
public:
	...
	UMotionSequenceObject();
	UMotionSequenceObject(UAnimSequence* InSequence, UMotionDataAsset* InParentMotionData);
	UMotionSequenceObject(UAnimSequence* InSequence, UMotionDataAsset* InParentMotionData, TArray<UDebugSkelMeshComponent*> InInteractionDebugSkelMeshComponents);
	...
	virtual void GetInteractionAnimsRootBoneTransforms(FTransform& OutTransform, int32 interactionIndex, const double Time) const override;
	virtual void CacheInteractionTrajectortPoints(TArray<TArray<FVector>>& OutTrajectoryPoints) const override;
};
...
public:
	...
	UMotionBlendSpaceObject();
	UMotionBlendSpaceObject(class UBlendSpace* InBlendSpace, UMotionDataAsset* InParentMotionData);
...
public:
	...
	UMotionCompositeObject();
	UMotionCompositeObject(class UAnimComposite* InComposite, UMotionDataAsset* InParentMotionData);
