...
public:
	...
	void SetInteractionAnimation(FMotionAnimAsset* InMotionAnim, UDebugSkelMeshComponent* InDebugMeshComponent,TArray<UDebugSkelMeshComponent*> InInteractionDebugSkelMeshComponents);
private:
