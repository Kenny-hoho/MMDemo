...
void SMotionTimeline::SetInteractionAnimation(FMotionAnimAsset* InMotionAnim, UDebugSkelMeshComponent* InDebugMeshComponent, TArray<UDebugSkelMeshComponent*> InInteractionDebugSkelMeshComponents)
{
	MotionAnim = InMotionAnim;
	DebugSkelMeshComponent = InDebugMeshComponent;
	...
	if (MotionAnim && DebugSkelMeshComponent)
	{
		...
		case EMotionAnimAssetType::Sequence:
		{
			Model = TSharedPtr<FMotionModel>(new FMotionModel_AnimSequenceBase((FMotionAnimSequence*)MotionAnim, InDebugMeshComponent, InInteractionDebugSkelMeshComponents));
		} break;
		case EMotionAnimAssetType::BlendSpace:
		{
			Model = TSharedPtr<FMotionModel>(new FMotionModel_BlendSpace((FMotionBlendSpace*)MotionAnim, InDebugMeshComponent, InInteractionDebugSkelMeshComponents));
		} break;
		case EMotionAnimAssetType::Composite:
		{
			Model = TSharedPtr<FMotionModel>(new FMotionModel_AnimComposite((FMotionComposite*)MotionAnim, InDebugMeshComponent, InInteractionDebugSkelMeshComponents));
		} break;
		}
