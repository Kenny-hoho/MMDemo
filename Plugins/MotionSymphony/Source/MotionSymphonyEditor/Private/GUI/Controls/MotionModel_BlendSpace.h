...
public:
	...
	FMotionModel_BlendSpace(FMotionBlendSpace* InMotionBlendSpace, UDebugSkelMeshComponent* InDebugSkelMesh,TArray<UDebugSkelMeshComponent*> InInteractionDebugSkelMeshs);
