...
private:
	...
	// 更新debuginfo到CustomDebugData
	void UpdateDebugInfo(FAnimInstanceProxy* InAnimInstanceProxy);
	void UpdateLowestPoses(FPoseMotionData& Pose, TArray<FPoseCostInfo>& LowestPoses, float Cost, float MomentumCost, float RotationalCost, float TrajectoryCost, float PoseCost);
};