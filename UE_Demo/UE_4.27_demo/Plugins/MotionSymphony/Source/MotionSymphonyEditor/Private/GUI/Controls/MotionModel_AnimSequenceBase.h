...
public:
	...
	FMotionModel_AnimSequenceBase(FMotionAnimSequence* InMotionAnim, UDebugSkelMeshComponent* InDebugSkelMesh,TArray<UDebugSkelMeshComponent*> InInteractionDebugSkelMeshs);
